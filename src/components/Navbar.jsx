  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <img src={logo} alt="logo2" className="w-9 h-9 object-contain" />

          <p className="text-white text-[18px]
           font-bold cursor-pointer flex">
            Ayush &nbsp; <span className="sm:block hidden">Dabhi</span>
          </p>
        </Link>
            ...
            >
              {navLinks.map((Link) => (
                <li
                  ...
                  onClick={() => {
                    setToggle(!toggle) 
                    // when we click on work so nav-toggle automatically closed after gone into that page
